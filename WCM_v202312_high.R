...
#SHOW RESULTS ----
RESULTS_CHN_CORN
write.table(RESULTS_CHN_CORN,paste0("./results/RESULTS_CHN_CORN_",snr_name,".csv"),row.names=FALSE,col.names=TRUE,sep=",")
#RESULTS_CHN_BE
#write.table(RESULTS_CHN_CORN,paste0("./results/RESULTS_CHN_BE_",snr_name,".csv"),row.names=FALSE,col.names=TRUE,sep=",")
#RESULTS_CORN
write.table(RESULTS_CORN,paste0("./results/RESULTS_CORN_",snr_name,".csv"),row.names=FALSE,col.names=TRUE,sep=",")
#RESULTS_BE
