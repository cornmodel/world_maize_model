...
N=ey-by
#N=37
#Sensitivity check: *1.01 1.025 1.05 1.1
sen=1.1
...
#SHOW RESULTS ----
RESULTS_CHN_CORN
write.table(RESULTS_CHN_CORN,paste0("./results/RESULTS_CHN_CORN_sen11",snr_name,".csv"),row.names=FALSE,col.names=TRUE,sep=",")
#RESULTS_CHN_BE
#write.table(RESULTS_CHN_CORN,paste0("./results/RESULTS_CHN_BE_",snr_name,".csv"),row.names=FALSE,col.names=TRUE,sep=",")
#RESULTS_CORN
write.table(RESULTS_CORN,paste0("./results/RESULTS_CORN_sen11",snr_name,".csv"),row.names=FALSE,col.names=TRUE,sep=",")
#RESULTS_BE
#write.table(RESULTS_CHN_CORN,paste0("./results/RESULTS_BE_",snr_name,".csv"),row.names=FALSE,col.names=TRUE,sep=",")
